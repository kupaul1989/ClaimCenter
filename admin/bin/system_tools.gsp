...
config.ServerOverrideUrl = new URL(SystemToolsArgs.Server + "/ws/gw/wsi/pl/SystemToolsAPI").toURI() as String
...
if( SystemToolsArgs.Ping ) {
  ...
  var pairFactory = new FilenameDigestPairFactory(SystemToolsArgs.VerifyConfig)
  ...
  print(api.verifyConfig(pairFactory.AppVerifiersConfigFP, pairFactory.PlVerifiersConfigFP, wsPairs))
