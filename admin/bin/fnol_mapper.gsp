...
uses gw.webservice.cc.cc901.claim.claimapi.ClaimAPI
uses java.lang.Long
uses java.net.URI
...
config.ServerOverrideUrl = new URI(FNOLMapperArgs.Server + "/ws/gw/webservice/cc/cc901/claim/ClaimAPI") as String
