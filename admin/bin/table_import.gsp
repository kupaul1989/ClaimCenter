...
function verifyRunLevelMaintenance() {
  ...
  config2.ServerOverrideUrl = new URL(TableImportArgs.Server + "/ws/gw/wsi/pl/SystemToolsAPI").toURI() as String
...
config.ServerOverrideUrl = new URL(TableImportArgs.Server + "/ws/gw/wsi/pl/TableImportAPI").toURI() as String
