...
public class TwilioMessageHistory_Adj extends com.guidewire.pl.web.codegen.LocationBase {
  private static function config () : com.guidewire.pl.web.navigation.LocationConfig {
    return __configOf(pcf.TwilioMessageHistory_Adj, LOCATION_CONFIG_CLASS)
  }
