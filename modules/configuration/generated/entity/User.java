...
public class User extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Validatable, entity.Obfuscatable, entity.EventAware, gw.api.obfuscation.Obfuscator {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TWILIOACCOUNTSID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TwilioAccountSID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TWILIOAUTHTOKEN_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TwilioAuthToken");
  ...
  /**
   * Gets the value of the TwilioAccountSID field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getTwilioAccountSID() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(TWILIOACCOUNTSID_PROP.get());
  }
  
  /**
   * Gets the value of the TwilioAuthToken field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getTwilioAuthToken() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(TWILIOAUTHTOKEN_PROP.get());
  }
  ...
  /**
   * Sets the value of the TwilioAccountSID field.
   */
  public void setTwilioAccountSID(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(TWILIOACCOUNTSID_PROP.get(), value);
  }
  
  /**
   * Sets the value of the TwilioAuthToken field.
   */
  public void setTwilioAuthToken(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(TWILIOAUTHTOKEN_PROP.get(), value);
  }
