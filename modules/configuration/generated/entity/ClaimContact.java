...
public class ClaimContact extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.EventAware, gw.api.contact.ContactHandle {
   ...
   */
  public void addToMessages(entity.TwilioSMS element) {
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.TwilioSMS[] getMessages() {
    return (entity.TwilioSMS[])__getInternalInterface().getFieldValue(MESSAGES_PROP.get());
  }
   ...
   */
  public void removeFromMessages(entity.TwilioSMS element) {
   ...
   */
  public void setMessages(entity.TwilioSMS[] value) {
