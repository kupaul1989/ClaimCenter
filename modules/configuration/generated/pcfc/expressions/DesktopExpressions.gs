...
class DesktopExpressions {
  ...
  public static class DesktopExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'location' attribute on LocationGroup (id=Desktop) at Desktop.pcf: line 35, column 46
    ...
    static function firstVisitableChildDestinationMethod_32 () : pcf.api.Destination {
      ...
      dest = pcf.TwilioMessageHistory_Adj.createDestination()
      if (dest.canVisitSelf()) {
        return dest
      }
      return null
    ...
    function menuActions_onEnter_28 (def :  pcf.DesktopMenuActions) : void {
      def.onEnter()
    }
    
    // 'menuActions' attribute on LocationGroup (id=Desktop) at Desktop.pcf: line 8, column 60
    function menuActions_refreshVariables_29 (def :  pcf.DesktopMenuActions) : void {
